...
features = ['price', 'item_count', 'store_id_1', 'n_people']
w = 90
f = 92
...
print(f"Validation features: {X_train.shape}")
...
monitor = EarlyStopping(monitor='val_loss', min_delta=0, patience=10, verbose=2, mode='auto', restore_best_weights=True)
...
submit_df.loc[submit_df['item_count'].le(0), 'item_count'] = 0
