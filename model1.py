...
for item in df['item_id'].unique():
    ...
    arr, forecast, identifier = timeseries_to_trainable(data, features=['price', 'item_count'],
                                                        target='item_count',
                                                        target_id='SUBMIT_ID',
...
monitor = EarlyStopping(monitor='val_loss', min_delta=0, patience=5, verbose=2, mode='auto', restore_best_weights=True)
